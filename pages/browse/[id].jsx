...
const YouTube = dynamic(
  () => import("../../node_modules/react-player/youtube"),
  { ssr: false }
);
const Vimeo = dynamic(() => import("../../node_modules/react-player/vimeo"), {
  ssr: false,
});
            ...
            >
              ...
              <div className="player-wrapper">
                <PlayerComponent
                  url={
                    video.player === "vimeo"
                      ? `https://vimeo.com/${video.urlID}`
                      : `https://www.youtube.com/embed/${video.urlID}`
                  }
              ...
              >
                {video.location} | {video.type} | {video.dateOfUpload}{" "}
              </div>
