      ...
      <section className="jumbotron text-center">
        <div className="container">
          ...
          <p className="lead text-muted">
            The device that you will use will determine what kind of experience
            you will have. There are different ways to experience the same
            video.
          </p>
        </div>
      </section>
            ...
            <div className="row g-0 ">
              ...
              >
                <div className="card card-body">
                  ...
                  <h5>Limitations:</h5>
                  <p>
                    1. iOS cannot be view the videos with Cardboard VR goggles
                    or stereoscopic view. <br />
                    2. However Android can (more instruction on how to view
                    below). <br />
                  </p>
                  <br></br>
                </div>
            ...
            <div className="row g-0 ">
              ...
              >
                <div className="card card-body">
                  ...
                  <h5>Limitations:</h5>
                  <p>
                    1. There is no mode where you can immerse yourself in the
                    video <br />
            ...
            <div className="row g-0 ">
              ...
              >
                <div className="card card-body">
                  <h5>Experience:</h5>
                  <p>
                    1. Download GizmoVR on Steam <br />
                  ...
                  <h5>Limitations:</h5>
                  <p>
                    1. Requires time to set up and to be able to view <br />
                    2. But you will get the full experience that was intended
                    for you
                  </p>
                  <br></br>
                </div>
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    A device where you can put your mobile phone in to view in
                    Virtual Reality
                  </p>
                </div>
              </div>
              ...
              >
                <div className="card card-body">
                  ...
                  <p>
                    1. Go to our browsing page <br />
                    2. Click on a video you want to watch <br />
                    3. Press the goggle icon to enter cardboard mode on the
                    Youtube link. <br />
                  ...
                  <h5>Limitations:</h5>
                  <p>
                    1. iOS Devices cannot use this mode. <br />
                    2. There is no way to control video once it is in the
                    headset without purchasing a bluetooth remote.
                  </p>
                  <br></br>
                </div>
              </div>
