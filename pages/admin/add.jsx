                  ...
                  {activeStep === 0 && (
                    ...
                    >
                      <div className="col-md-4">
                        <label htmlFor="player" className="col-form-label">
                          1. Choose Video Player:
                        </label>
                        <br />
                        <div style={{ display: "flex", paddingTop: "7px" }}>
                          <div className="form-check">
                            <input
                              ...
                              id="youtubeRadio"
                              value="youtube"
                              {...register("player", { required: false })}
                            />
                            <label
                      ...
                      >
                        ...
                        >
                          ...
                          <input
                            ...
                            type="date"
                            id="dateOfUpload"
                            {...register("dateOfUpload", { required: false })}
                          />
                        </div>
