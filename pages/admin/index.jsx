...
export default function AdminPage({ videos, categories }) {
  ...
  function renderVideoCards() {
    const videosToDisplay = videos.filter((video) => {
      let videoLocation =
        location === "all" ? true : video.location === location;
      let videoType =
        selectedCatDropbox === "all" ? true : video.type === selectedCatDropbox;
      let searched = video.title
        .toLowerCase()
  ...
  if (session) {
    return (
      <main
        role="main"
        style={{ paddingTop: "7vh", background: "#f8f9fa", height: "100%" }}
      >
        <div>
          <Head>
          ...
          <div className="row g-0">
            ...
            >
                ...
                <div style={{ justifyContent: "center" }}>
                  <Button color="error">
                    <Link href="/admin/add" style={{ color: "black" }}>
                      <img
                        className="hover"
                        src="https://static.thenounproject.com/png/767525-200.png"
                        width="60%"
                        height="auto"
              ...
              <div className="input-group rounded justify-content-center">
                ...
                />
                <Button className="fas fa-search" onClick={clear}>
